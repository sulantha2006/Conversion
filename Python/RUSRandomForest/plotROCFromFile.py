...
def plotROC(fpr, tpr, th, legend_title, plot_title, fileName):
    ...
    plt.annotate('Sen : {0}\nSpec: {1}\nTh: {2}'.format(optY, 1 - optX, optTH), xy=(optX, optY), xytext=(0.25, 0.75),
                 arrowprops=dict(arrowstyle='fancy', fc='0.6', ec='none', shrinkB=5,
...
if __name__ == '__main__':
    ...
    plotROC(1 - data[:, 0], data[:, 1], data[:, 2], 'CSF AV45', 'ROC for MCI Converters (CSF & AV45)',
            'CSF_AV45_ROC.png')
